...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KeepGrouped.API.Users.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("KeepGrouped.API.Events.Registration", b =>
                {
                    ...
                    b.HasOne("KeepGrouped.API.Users.ApplicationUser", "User")
                        .WithMany("Registrations")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("KeepGrouped.API.Users.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
